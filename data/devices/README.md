...
**正本詳細:** [Excel入力フォーマット\_v0.3.md](../docs/03_技術仕様/Excel入力フォーマット_v0.3.md)（v0.3 入力）· [Excel取込.md](../docs/03_技術仕様/Excel取込.md)（正規化パイプライン）· [構成詳細.md §data](../docs/04_リポジトリ構造/構成詳細.md)
...
| `import.json`              | **対象**   | Python 正規化出力 → Web **「装置を取込…」**（import.json のみ · [暫定方針](../../docs/01_要求定義/grill-me_2026-06-28_装置取込暫定方針.md)） |
| **PC 変換（作者）**        | —          | **`FlowchartStudio-ExcelConverter.exe`** — [装置Excel変換exe.md](../../docs/03_技術仕様/装置Excel変換exe.md)                                 |
| `README.md`                | 任意       | 装置メモ                                                                                                                                     |
...
会社ルールの **装置ごと設計フォルダ**（社内サーバー）に xlsx · import.json を置く。Git には載せない。Web 取込は **import.json をファイル選択**（xlsx は PC で先に変換 · [暫定方針](../docs/01_要求定義/grill-me_2026-06-28_装置取込暫定方針.md)）。
