...
| **戦術次タスク** | [HANDOFF §6](c:/yk-memo/handoffs/flowchart-studio/HANDOFF.md) | **表ペイン UX 実装**（§4）         |
...
| 2026-06-25      | UX       | 表ペイン UX 方針（スクロール · 列リサイズ · レイアウト統一）                    | [表ペインUX方針.md](../02_機能設計/表ペインUX方針.md)                                                                                                                                                                                     | 合意                              | 次: §4 実装                                                                                                                          |
