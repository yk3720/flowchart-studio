...
- [ ] **ADR-018:** 技術デモ **DEMO0000（塗布装置）** · 一般 **2×2 同梱シード** · 未保存オフ · 雛形削除（→ [ADR-018](<../03_技術仕様/意思決定記録(ADR).md#adr-018-3-ペイン入替--右ドック--デモ整備草案--2026-06-27>) · [grill デモ整備](../01_要求定義/grill-me_2026-06-27_デモ整備とレイアウト.md)）
