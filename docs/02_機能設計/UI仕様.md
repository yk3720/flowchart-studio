...
| ペイン幅リセット（T4）        | **実装済**（§D · 表ツールバー）· **§E で N9 へ移動予定**                                                                   |

### 表ペイン UX 改定パック（2026-06-26 · 合意済 · 未実装）

**方針 SSOT:** [表ペインUX方針 §E](./表ペインUX方針.md#e-表ペイン-ux-改定パック2026-06-26--合意済--未実装) · ナビ [ワークスペースレイアウト方針 §F](./ワークスペースレイアウト方針.md#f-ナビタイトル--ペイン幅リセット移動2026-06-26-合意済--未実装) · ボタン [ボタン一覧.md](./ボタン一覧.md)
...
| T4 列幅リセット     | **廃止**                                        |
| T4 ペイン幅リセット | 表ツールバーに新設（**§E で N9 へ移動予定**）   |

> **§E 未実装:** 上記 §D の T1/T4 配置は現行コードの正。改定後は [§E 改定パック](#表ペイン-ux-改定パック2026-06-26--合意済--未実装) を正とする。
