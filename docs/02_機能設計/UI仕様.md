...
> **ADR-018（第2弾 · 未実装 · 2026-06-27）:** 以下の「現行実装」は **コード現状**。**改定後:** Nav｜**図**｜**表** · 右 `[表|設計メモ|コメント]` · ペイン3内 chrome · 本番列の意味なし · D1 — 正本 [ADR-018](<../03_技術仕様/意思決定記録(ADR).md#adr-018-3-ペイン入替--右ドック--デモ整備草案--2026-06-27>) · [grill 右ペイン](../01_要求定義/grill-me_2026-06-27_右ペインと3ペイン整理.md)。
