...
**更新:** 2026-06-27（ADR-018 草案追記）  
**目次:** [00\_目次.md](./00_目次.md)  
**関連:** [ADR-009](<../03_技術仕様/意思決定記録(ADR).md>) · [ADR-011](<../03_技術仕様/意思決定記録(ADR).md>) · [ADR-013](<../03_技術仕様/意思決定記録(ADR).md>) · [ADR-018 草案](<../03_技術仕様/意思決定記録(ADR).md#adr-018-3-ペイン入替--右ドック--デモ整備草案--2026-06-27>) · [要求定義書.md](../01_要求定義/要求定義書.md) §4

> **ADR-018 草案（未実装 · 2026-06-27）:** 以下の「現行実装」は **コード現状（Nav｜表｜図 · 52:48 · 表下 details）** を記す。**改定後:** Nav｜**図**｜**表** · **2｜4｜6** · 右 `[表|設計メモ]` タブ · 列の意味/CSV→その他 · 雛形削除 — 正本 [ADR-018](<../03_技術仕様/意思決定記録(ADR).md#adr-018-3-ペイン入替--右ドック--デモ整備草案--2026-06-27>) · [grill](../01_要求定義/grill-me_2026-06-27_デモ整備とレイアウト.md)。
...
**ADR-018 改定後（未実装）:** Nav **17%** · 図 **33%** · 表 **50%**（**2｜4｜6** · `workspace-inner-v3` 想定）。
