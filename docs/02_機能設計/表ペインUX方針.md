...
**状態:** スクロール・レイアウト統一は完了（2026-06-25 · `523a008`）。**縦優先レイアウト改定（§D）· T4 差し替えは実装済**（2026-06-25）。  
...
**最終更新:** 2026-06-25（§D 縦優先レイアウト · T4 差し替え **実装済** · `523a008` スクロール済）
