...
| **戦術次タスク** | [HANDOFF §6](c:/yk-memo/handoffs/flowchart-studio/HANDOFF.md)                   | **U0 動作001 本文**（§4 · 1個ずつ） |
...
| 2026-06-24      | 運用     | UX パック — 名称統一・内部キー・再生成 UX・凡例 chrome・handoffs slug           | [handoff \_19](c:/yk-memo/handoffs/flowchart-studio/2026-06-24_19_ux-rename-scroll-legend-handoff.md)                                                                                                                               | 完了                              | 次: U0 動作001 §4                                                                                                                    |
