...
| 2026-06-24      | 運用     | Magic Link / PKCE — `/auth/confirm` + メールテンプレ整合        | [SUPABASE_SETUP.md](../../docs/SUPABASE_SETUP.md) §1-1 · `app/auth/confirm/route.ts`                                                                                                                                                | コード完了 · ダッシュボード設定要 | 開発: 3方式共存 · 本番: Email 無効                                                                                                   |
