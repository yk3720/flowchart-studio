...
**関連:** [データモデル.md](./データモデル.md) · [ADR-014](<../03_技術仕様/意思決定記録(ADR).md>) · [ADR-013](<../03_技術仕様/意思決定記録(ADR).md>) · [001_db1_schema.sql](c:/yk-application/flowchart-studio/supabase/migrations/001_db1_schema.sql)
